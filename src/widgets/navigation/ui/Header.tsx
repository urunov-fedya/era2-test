...
import {Clock, Layers, Menu, Moon, Search, Sun} from "lucide-react";
      ...
      >
        ...
        <div className='flex items-center gap-3'>
          ...
          <Link to='/' className='flex items-center gap-2.5 shrink-0'>
            ...
            >
              ...
              <span
                className='font-mono text-[13px] font-normal ml-0.5'
        ...
        <div className='flex items-center gap-1.5 sm:gap-2'>
          ...
          >
            ...
            <span className='bg-card rounded-md px-1.5 py-0.5 text-[10px] font-mono text-muted-foreground'>
              ⌘K
            </span>
          </button>
          <button
            ...
            <div className='flex items-center gap-1.5 sm:gap-2'>
              ...
              <Link
                ...
                style={{
                  ...
                  boxShadow: "0 4px 16px -4px rgba(232, 84, 32, 0.5)",
                }}
              >
                Начать
              </Link>
